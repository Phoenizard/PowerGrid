...
def plot_results(output_path: str, figures_dir: str):
    ...
    ax.set_title("Damping Sensitivity: Critical Coupling vs Damping", fontsize=13)
    ...
    ax.set_title("Absolute Reduction from Edge Addition (m=4)", fontsize=13)
    ax.legend(fontsize=11)
    ax.grid(True, alpha=0.3)
    fig.tight_layout()
    ...
    ax.set_title("Relative Effectiveness of Edge Addition vs Damping", fontsize=13)
    ax.legend(fontsize=11)
    ax.grid(True, alpha=0.3)
    fig.tight_layout()
